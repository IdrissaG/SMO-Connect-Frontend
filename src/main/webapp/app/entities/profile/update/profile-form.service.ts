...
type ProfileFormGroupContent = {
  ...
  typeUtilisateur: FormControl<IProfile['typeUtilisateur']>;
  matricule: FormControl<IProfile['matricule']>;
  structure: FormControl<IProfile['structure']>;
  prestataire: FormControl<IProfile['prestataire']>;
  plateau: FormControl<IProfile['plateau']>;
};
...
export class ProfileFormService {
  createProfileFormGroup(profile?: ProfileFormGroupInput): ProfileFormGroup {
    ...
    return new FormGroup<ProfileFormGroupContent>({
      ...
      typeUtilisateur: new FormControl(profileRawValue.typeUtilisateur, {
        validators: [Validators.required],
      }),
      matricule: new FormControl(profileRawValue.matricule, {
        validators: [Validators.maxLength(50)],
      }),
      structure: new FormControl(profileRawValue.structure, {
        validators: [Validators.maxLength(200)],
      }),
      prestataire: new FormControl(profileRawValue.prestataire),
      plateau: new FormControl(profileRawValue.plateau),
    });
  }
