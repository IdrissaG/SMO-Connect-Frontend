...
import { UploadLogDeleteDialog } from './upload-log-delete-dialog';

describe('UploadLog Management Delete Component', () => {
  let comp: UploadLogDeleteDialog;
  let fixture: ComponentFixture<UploadLogDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(UploadLogDeleteDialog);
