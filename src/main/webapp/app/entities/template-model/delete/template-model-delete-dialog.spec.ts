...
import { TemplateModelDeleteDialog } from './template-model-delete-dialog';

describe('TemplateModel Management Delete Component', () => {
  let comp: TemplateModelDeleteDialog;
  let fixture: ComponentFixture<TemplateModelDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TemplateModelDeleteDialog);
