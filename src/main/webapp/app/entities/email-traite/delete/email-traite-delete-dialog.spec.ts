...
import { EmailTraiteDeleteDialog } from './email-traite-delete-dialog';

describe('EmailTraite Management Delete Component', () => {
  let comp: EmailTraiteDeleteDialog;
  let fixture: ComponentFixture<EmailTraiteDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EmailTraiteDeleteDialog);
