...
import { PrestataireDeleteDialog } from './prestataire-delete-dialog';

describe('Prestataire Management Delete Component', () => {
  let comp: PrestataireDeleteDialog;
  let fixture: ComponentFixture<PrestataireDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PrestataireDeleteDialog);
