...
import sn.sonatel.dsi.ftsirc.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.reactive.ResponseUtil;

/**
 * REST controller for managing {@link sn.sonatel.dsi.ftsirc.domain.Authority}.
 */
@RestController
...
public class AuthorityResource {
    ...
    @Value("${jhipster.clientApp.name:sMOConnectFrontend}")
